 ...
 * 2013-05-15T13:52:38.781+08:00
 * Generated source version: 2.7.4
 * 
 */
@WebServiceClient(name = "Service", 
                  wsdlLocation = "classpath:wsdl/sms-nuo.wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = Service.class.getClassLoader().getResource("wsdl/sms-nuo.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/sms-nuo.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
