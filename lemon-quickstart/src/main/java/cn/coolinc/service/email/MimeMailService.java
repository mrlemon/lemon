package cn.coolinc.service.email;
...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("emailtestserver@163.com");
			helper.setFrom("emailtestserver@163.com");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至emailtestserver@163.com");
